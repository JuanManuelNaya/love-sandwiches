...
def get_sales_data():
    ...
    via the terminal. wich must be a string of 6 numbers separeted
...
def calculate_surplus_data(sales_row):
    """
    Compare sales with stock and calculate the surplues for each item type.

    The surplus is defined as the sales figure subtracted from the sock:
    - Posive surplus indicates waste
    -Negative surplus indicates extra made when stock was sold out.
    """
    print("Calculating surplues data...\n")
...
def calculate_stock_data(data):
    """
    Calcula the average stock for each item type, adding 10%
    """
